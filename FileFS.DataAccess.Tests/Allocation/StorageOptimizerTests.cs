...
namespace FileFS.DataAccess.Tests.Allocation
{
    public class StorageOptimizerTests
    {
        ...
        public void Optimize_WhenGapsExists_ShouldCutThemOff()
        {
            ...
            fileRepository.Create(new FileEntry("some_file", "some_directory", data));
            fileRepository.Create(new FileEntry("some_other_file", "some_directory", data));
            fileRepository.Create(new FileEntry("some_other_other_file", "some_directory", data));
            fileRepository.Create(new FileEntry("some_other_other_other_file1", "some_directory", data));
            fileRepository.Create(new FileEntry("some_other_other_other_file2", "some_directory", data));
